"Warrior": Tech 1 Medium Infantry Kbot
----
<table align="right">
    <thead>
        <tr>
            <th align="left" colspan="2">
                <img align="left" title="Warrior unit icon" src="icons/units/ARMWAR_icon.png" />Warrior<br />Tech 1 Medium Infantry Kbot
            </th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td><img src="icons/health.png" title="Health" /> 640</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><img src="icons/energy.png" title="Energy" /> 2236</td>
        </tr>
        <tr>
            <td align="right"><strong>Mass cost:</strong></td>
            <td><img src="icons/mass.png" title="Mass" /> 196</td>
        </tr>
        <tr>
...
"Warrior" is an ARM land unit included in *SCTATest*.
It is classified as a tech 1 medium infantry kbot unit. It has no defined build description, and no categories to define common builders.
...
* <img src="icons/time.png" title="Time" /> 00:57 ‒ <img src="icons/energy.png" title="Energy" /> 39/s ‒ <img src="icons/mass.png" title="Mass" /> 3/s — Built by <a href="ARMLAB">Tech 1 Produces Kbots</a>
...
<p>
    <table>
        ...
        <tr>
            ...
            <td>12 <span title="Note: This doesn't count additional scripted effects, such as splintering projectiles, and variable scripted damage.">(<u>?</u>)</span></td>
        </tr>
        <tr>
...
<details>
<summary>ARMWAR_LCANNON</summary>
<p>
    <table>
        <tr>
            <td align="right"><strong>Target type:</strong></td>
