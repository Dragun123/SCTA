"Shooter": Tech 2 Sniper Kbot
----
<table align="right">
    <thead>
        <tr>
            <th align="left" colspan="2">
                <img align="left" title="Shooter unit icon" src="icons/units/ARMSNIPE_icon.png" />Shooter<br />Tech 2 Sniper Kbot
            </th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td><img src="icons/energy.png" title="Energy" /> 14727</td>
        </tr>
        <tr>
            <td align="right"><strong>Mass cost:</strong></td>
            <td><img src="icons/mass.png" title="Mass" /> 935</td>
        </tr>
        <tr>
...
"Shooter" is an ARM land unit included in *SCTATest*.
It is classified as a tech 2 sniper kbot unit. It has no defined build description, and no categories to define common builders.
...
* <img src="icons/time.png" title="Time" /> 02:20 ‒ <img src="icons/energy.png" title="Energy" /> 105/s ‒ <img src="icons/mass.png" title="Mass" /> 7/s — Built by <a href="ARMALAB">Tech 2 Produces Kbots</a>
...
<p>
    <table>
        ...
        <tr>
            ...
            <td>1250 <span title="Note: This doesn't count additional scripted effects, such as splintering projectiles, and variable scripted damage.">(<u>?</u>)</span></td>
        </tr>
        <tr>
