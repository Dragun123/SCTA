...
Description = table.merged( Description, {
    ...
    ['armch'] = "An Engineering Hovercraft Builds T1 Economic, and T2 Military",
      ...
      -- Seaplane Con
    ['armcsa'] = "An Engineering Seaplane Builds T1 Economic, and T2 Military",
    ['corcsa'] = "An Engineering Seaplane Builds T1 Economic, and T2 Military",

    ['armaap'] = "<LOC armaap_help> An Advanced Aircraft Plant can build Advanced Construction Aircraft, and level 2 Aircraft.",
    ['armaas'] = "<LOC armaas_help> Anti-Air Naval Unit, armed with Flak Cannons and Missiles."           ,
    ['armah'] = "<LOC armah_help>."             ,
    ['armalab'] = "<LOC armalab_help> An Advanced Kbot Plant, can build Advanced Construction Kbots, and level 2 Kbots.",
    ['armamb'] = "<LOC armamb_help>."           ,
    ['armamd'] = "<LOC armamd_help>."           ,
    ['armamph'] = "<LOC armamph_help>."         ,
    ['armanac'] = "<LOC armanac_help>."         ,
    ['armanni'] = "<LOC armanni_help>."         ,
    ['armap'] = "<LOC armap_help> An Aircraft Plant can build Construction Aircraft, and level 1 Aircraft.",
    ...
    ['armason'] = "<LOC armason_help> With its more powerful sonar, this advanced facility can detect ocean going CORE forces earlier, but is easily fooled by jamming and stealth.."         ,
    ['armasp'] = "<LOC armasp_help> Automatically repairs aircraft."           ,
    ['armasy'] = "<LOC armasy_help> An Advanced Shipyard can build Advanced Construction Sub, and Level 2 Navy."           ,
    ...
    ['armavp'] = "<LOC armavp_help> An Advanced Vehicle Plant can build Advanced Construction Vehicles, and level 2 Vehicles.",
    ...
    ['armfig'] = "<LOC armfig_help> ARM's basic anti-air fighter."           ,
    ...
    ['armhawk'] = "<LOC armhawk_help> ARM's stealth fighter, and capable of dueling the most advanced air units."         ,
    ['armhlt'] = "<LOC armhlt_help>."           ,
    ['armhp'] = "<LOC armhp_help> A Hovercraft Plant can build Construction Hovercraft, and Level 1 Hover Units"             ,
    ['armjam'] = "<LOC armjam_help>."           ,
    ['armjeth'] = "<LOC armjeth_help>."         ,
    ['armlab'] = "<LOC armlab_help> A Kbot Plant can build Construction Kbots, and level 1 Kbots.",
    ...
    ['armsy'] = "<LOC armsy_help> A Shipyard can build Construction Ships, and Level 1 Navy."             ,
    ['armtarg'] = "<LOC armtarg_help> Enables Radar Targeting."         ,
    ['armthund'] = "<LOC armthund_help>."       ,
    ['armtide'] = "<LOC armtide_help> ARM Power Generator, energy generated varies unpredictably."         ,
    ['armtl'] = "<LOC armtl_help>."             ,
    ['armvader'] = "<LOC armvader_help>."       ,
    ['armvp'] = "<LOC armvp_help> A Vehicle Plant can build Construction Vehicles, and level 1 Vehicles.",
    ['armvulc'] = "<LOC armvulc_help> A powerful piece of artillery, and one of the most destructive weapons in ARM's arsenal with gattling like rate of fire."         ,
    ['armwar'] = "<LOC armwar_help>."           ,
    ['armwin'] = "<LOC armwin_help>."           ,
    ['armyork'] = "<LOC armyork_help>."         ,
    ['armzeus'] = "<LOC armzeus_help>."         ,
    ['coraap'] = "<LOC coraap_help> An Advanced Aircraft Plant can build Advanced Construction Aircraft, and level 2 Aircraft.",
    ['corah'] = "<LOC corah_help>."             ,
    ['corak'] = "<LOC corak_help>."             ,
    ['coralab'] = "<LOC coralab_help> An Advanced Kbot Plant can build Advanced Construction Kbots, and level 2 Kbots.",
    ['coramph'] = "<LOC coramph_help>."         ,
    ['corap'] = "<LOC corap_help> An Air Plant can build Construction Aircraft, and level 1 Aircraft.",
    ['corape'] = "<LOC corape_help>."           ,
    ['corarad'] = "<LOC corarad_help> With a much larger tranceiver, the advanced radar tower can detect approaching ARM forces far in advance, but is easily fooled by jamming and stealth."         ,
    ['corarch'] = "<LOC corarch_help> Anti-Air Naval Unit, armed with Flak Cannons and Missile.."         ,
    ['corason'] = "<LOC corason_help> With its more powerful sonar, this advanced facility can detect ocean going ARM forces earlier, but is easily fooled by jamming and stealth."         ,
    ['corasp'] = "<LOC corasp_help> Automatically repairs aircraft."           ,
    ['corasy'] = "<LOC corasy_help> An Advanced Shipyard can build Advanced Construction Sub, and Level 2 Navy."           ,
    ['coratl'] = "<LOC coratl_help>."           ,
    ['coravp'] = "<LOC coravp_help> An Advanced Vehicle Plant can build Advanced Construction Vehicles, and level 2 Vehicles.",
    ['corawac'] = "<LOC corawac_help>."         ,
    ['corbats'] = "<LOC corbats_help>."         ,
    ['corbuzz'] = "<LOC corbuzz_help> CORE's most powerful stationary weapon platform, with its ability to annihilate ARM forces anywhere on the battlefield."         ,
    ...
    ['cordecom'] = "<LOC cordecom_help> When ARM forces detected the prescence of the lone CORE commander on their icy shores, a facimile commander had been constructed by the CORE in deception. Reclaims, repairs, and assists. No engineering suite nor Disintigration Gun. Explodes violently on death"       ,
    ...
    ['corhp'] = "<LOC corhp_help> A Hovercraft Plant can build Construction Hovercraft, and Level 1 Hover Units"             ,
    ['corhrk'] = "<LOC corhrk_help>."         ,
    ['corhurc'] = "<LOC corhurc_help>."         ,
    ['corhunt'] = "<LOC corhunt_help>."           ,
    ['corint'] = "<LOC corint_help>."           ,
    ['corkrog'] = "<LOC corkrog_help> The Secret Weapon of the Central Consciousness, designed to retake the Galaxy from the ARM Usurpers."         ,
    ['corlab'] = "<LOC corlab_help> A Kbot Plant can build Construction Kbots, and level 1 Kbots."           ,
    ['corlevlr'] = "<LOC corlevlr_help>."       ,
    ['corllt'] = "<LOC corllt_help>."           ,
    ['cormabm'] = "<LOC cormabm_help>."         ,
    ['cormakr'] = "<LOC cormakr_help> Consumes energy to create metal. Useful in locations where deposits are scarce but requires immense energy to create and maintain.",
    ...
    ['corsy'] = "<LOC corsy_help> A Shipyard can build Construction Ships, and Level 1 Navy."             ,
    ['cortarg'] = "<LOC cortarg_help> Enables Radar Targeting."         ,
    ['corthud'] = "<LOC corthud_help>."         ,
    ['cortide'] = "<LOC cortide_help> CORE Power Generator, energy generated varies unpredictably."         ,
    ['cortitan'] = "<LOC cortitan_help>."       ,
    ['cortl'] = "<LOC cortl_help>."             ,
    ['cortoast'] = "<LOC cortoast_help>."       ,
    ['cortron'] = "<LOC cortron_help>."         ,
    ['corvalk'] = "<LOC corvalk_help> Rapid air transport capable of ferrying CORE raiding forces deep within ARM territory. Carries 4 T1 land units.",
    ['corvamp'] = "<LOC corvamp_help> CORE's stealth fighter, and capable of dueling the most advanced air units."         ,
    ['corveng'] = "<LOC corveng_help> CORE's basic anti-air fighter."         ,
    ['corvipe'] = "<LOC corvipe_help>."         ,
    ['corvp'] = "<LOC corvp_help> A Vehicle Plant can build Construction Vehicles, and level 1 Vehicles.",
