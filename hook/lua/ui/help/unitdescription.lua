...
Description = table.merged( Description, {
    ...
    ['armaap'] = "An Advanced Aircraft Plant can build Advanced Construction Aircraft, and level 2 Aircraft.",
    ['armaas'] = "<LOC armaas_help>."           ,
    ['armah'] = "<LOC armah_help>."             ,
    ['armalab'] = "An Advanced Kbot Plant, can build Advanced Construction Kbots, and level 2 Kbots.",
    ['armamb'] = "<LOC armamb_help>."           ,
    ['armamd'] = "<LOC armamd_help>."           ,
    ['armamph'] = "<LOC armamph_help>."         ,
    ['armanac'] = "<LOC armanac_help>."         ,
    ['armanni'] = "<LOC armanni_help>."         ,
    ['armap'] = "An Aircraft Plant can build Construction Aircraft, and level 1 Aircraft.",
    ...
    ['armavp'] = "An Advanced Vehicle Plant can build Advanced Construction Vehicles, and level 2 Vehicles.",
    ...
    ['armlab'] = "A Kbot Plant can build Construction Kbots, and level 1 Kbots.",
    ...
    ['armvp'] = "A Vehicle Plant can build Construction Vehicles, and level 1 Vehicles.",
    ['armvulc'] = "<LOC armvulc_help>."         ,
    ['armwar'] = "<LOC armwar_help>."           ,
    ['armwin'] = "<LOC armwin_help>."           ,
    ['armyork'] = "<LOC armyork_help>."         ,
    ['armzeus'] = "<LOC armzeus_help>."         ,
    ['coraap'] = "An Advanced Aircraft Plant can build Advanced Construction Aircraft, and level 2 Aircraft.",
    ['corah'] = "<LOC corah_help>."             ,
    ['corak'] = "<LOC corak_help>."             ,
    ['coralab'] = "An Advanced Kbot Plant can build Advanced Construction Kbots, and level 2 Kbots.",
    ['coramph'] = "<LOC coramph_help>."         ,
    ['corap'] = "An Air Plant can build Construction Aircraft, and level 1 Aircraft.",
    ...
    ['coravp'] = "An Advanced Vehicle Plant can build Advanced Construction Vehicles, and level 2 Vehicles.",
    ...
    ['corvp'] = "A Vehicle Plant can build Construction Vehicles, and level 1 Vehicles.",
