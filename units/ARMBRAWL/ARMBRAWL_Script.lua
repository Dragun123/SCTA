...
ARMBRAWL = Class(TAair) {
	...
	OpenWings = function(self)
		...
		self.Spinners.wing1:SetGoal(-2.9,0,0)
		self.Spinners.wing1:SetSpeed(2)

		--MOVE wing2 to x-axis <-2.90> SPEED <2.00>;
		self.Spinners.wing2:SetGoal(2.9,0,0)
		self.Spinners.wing2:SetSpeed(2)
		...
		self.Spinners.weapon1:SetGoal(2.9,0,0)
		self.Spinners.weapon1:SetSpeed(2)

		--MOVE weapon2 to x-axis <2.95> SPEED <2.00>;
		self.Spinners.weapon2:SetGoal(-2.9,0,0)
		self.Spinners.weapon2:SetSpeed(2)
	end,

	CloseWings = function(self)

		--MOVE weapon1 to x-axis <0> SPEED <2.00>;
		self.Spinners.weapon1:SetGoal(0,0,0)
		self.Spinners.weapon1:SetSpeed(2)

		--MOVE weapon2 to x-axis <0> SPEED <2.00>;
		self.Spinners.weapon2:SetGoal(0,0,0)
		self.Spinners.weapon2:SetSpeed(2)

		--SLEEP <998>;

		--MOVE wing1 to x-axis <0> SPEED <2.00>;
		self.Spinners.wing1:SetGoal(0,0,0)
		self.Spinners.wing1:SetSpeed(2)

		--MOVE wing2 to x-axis <0> SPEED <2.00>;
		self.Spinners.wing2:SetGoal(0,0,0)
		self.Spinners.wing2:SetSpeed(2)
