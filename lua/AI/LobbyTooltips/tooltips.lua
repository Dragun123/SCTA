--Adds tooltip info to the lobby for sctaAI and sctaAIx.
...
Tooltips = {
    ...
    aitype_sctaairandom = {
        title = "<LOC SCTAAI_0003>AI: SCTA Random",
    ...
    aitype_sctaairandomcheat = {
        title = "<LOC SCTAAI_0006>AIx: SCTA Random",
        description = "<LOC SCTAAI_0006>A rush AI. Chooses at Random between ARM or CORE.",
    },
}
